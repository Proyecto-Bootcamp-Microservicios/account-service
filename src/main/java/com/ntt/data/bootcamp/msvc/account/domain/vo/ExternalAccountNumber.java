...
public final class ExternalAccountNumber {
  ...
  private ExternalAccountNumber(String value) {
    ...
    if (value == null || value.isEmpty())
      throw new IllegalArgumentException("ExternalAccountNumber cannot be null or blank");
    if (!isValidExternalAccountNumber(value))
      throw new IllegalArgumentException("ExternalAccountNumber must be 24 characters long");
    this.value = value;
  }
