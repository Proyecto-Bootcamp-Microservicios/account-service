...
public final class AccountHolder {
  ...
  private AccountHolder(
    ...
    if (participationPercentage == null
        ...
        || participationPercentage.compareTo(BigDecimal.valueOf(100)) > 0)
  ...
  public static AccountHolder ofPrimaryHolder(
      String documentType, String documentNumber, BigDecimal recalculatedPercentage) {
    return new AccountHolder(documentType, documentNumber, recalculatedPercentage, true);
  }

  public static AccountHolder ofSecondaryHolder(
      String documentType, String documentNumber, BigDecimal participationPercentage) {
