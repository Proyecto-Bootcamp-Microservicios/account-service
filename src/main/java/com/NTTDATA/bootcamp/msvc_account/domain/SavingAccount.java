...
public class SavingAccount extends Account {
    ...
    private SavingAccount(String id, String customerId, String customerType,
        ...
        super(id, customerId, customerType, documentType, documentNumber,
                accountNumber, externalAccountNumber, accountType, status,
                balance, audit, holders, transactionLimit);
    ...
    public static SavingAccount of(String customerId, String customerType, String documentType, String documentNumber){
        ...
        return new SavingAccount(UUID.randomUUID().toString(), customerId, customerType, documentType, documentNumber,
                ...
                Balance.zero("PEN"), Audit.create(), new HashSet<>(), TransactionLimit.of());
    }
    ...
    public static SavingAccount of(String customerId, String customerType, String documentType, String documentNumber, BigDecimal amount){
        ...
        return new SavingAccount(UUID.randomUUID().toString(), customerId, customerType, documentType, documentNumber,
                internalAccountNumber, externalAccountNumber, AccountType.SAVING, AccountStatus.ACTIVE,
                Balance.of("PEN", amount), Audit.create(), new HashSet<>(), TransactionLimit.of());
    }

    public static SavingAccount reconstruct(String id, String customerId, String customerType, String documentType, String documentNumber, String accountNumber, String externalAccountNumber, AccountType accountType, AccountStatus status, Balance balance, Audit audit, Set<AccountHolder> holders, TransactionLimit transactionLimit) {
        return new SavingAccount(id, customerId, customerType, documentType, documentNumber, accountNumber, externalAccountNumber, accountType, status, balance, audit, holders, transactionLimit);
    }
    ...
    protected void validateBusinessRules() {
        ...
        if(this.transactionLimit == null) throw new IllegalArgumentException("Transaction limit cannot be null");
    }
    ...
    public Account changeStatus(AccountStatus status) {
        ...
        return new SavingAccount(this.getIdValue(), this.customerId, this.customerType,
                this.getDocumentType(), this.getDocumentNumber(),
                this.getAccountNumber(), this.getExternalAccountNumber(), this.accountType, status,
                this.balance, this.audit.update(), this.holders, this.transactionLimit);
    }
    ...
    public Account withNewBalance(Balance newBalance) {
        return new SavingAccount(this.getIdValue(), this.customerId, this.customerType,
                this.getDocumentType(), this.getDocumentNumber(),
                this.getAccountNumber(), this.getExternalAccountNumber(), this.accountType, this.status,
                newBalance, this.audit.update(), this.holders, this.transactionLimit);
    }
    ...
    public Account withNewTransactionLimit(TransactionLimit newTransactionLimit) {
        return new SavingAccount(this.getIdValue(), this.customerId, this.customerType,
                this.getDocumentType(), this.getDocumentNumber(),
                this.getAccountNumber(), this.getExternalAccountNumber(), this.accountType, this.status,
                this.balance, this.audit.update(), this.holders, newTransactionLimit);
    }
