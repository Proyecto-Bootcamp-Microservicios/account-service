...
public class CheckingAccountCollection extends AccountCollection {
    ...
    public CheckingAccountCollection(String id, String customerType, String customerId,
        ...
        super(id, customerType, customerId, accountType, accountNumber, externalAccountNumber, status, holders, balance, createdAt, updatedAt);
